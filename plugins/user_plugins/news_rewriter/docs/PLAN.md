...
Статус: **этапы 0–5, 6.1 (HttpSink) и 6.3 (универсальный extractor) реализованы;
остальные задачи этапа 6 — по мере надобности.**
...
правок ядра плагина. — **6.1 и 6.3 выполнены** (HttpSink регистрируется в
