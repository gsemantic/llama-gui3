...
/**
 * @namespace agents
 * @brief Система агентов с встроенными инструментами
 * 
 * @section overview Обзор
 * 
 * Система агентов позволяет расширять функциональность приложения
 * через встроенные агенты. Каждый агент реализует интерфейс IAgent
 * и регистрируется в AgentRegistry.
 * 
 ...
 * @endcode
 * 
 * @section plugins Создание агентов
 * 
 * Новые агенты создаются наследованием от IAgent и регистрации
 * в AgentRegistry. Агенты компилируются статически в бинарник.
 */
namespace agents {
